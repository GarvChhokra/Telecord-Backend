...
@app.route('/getAllCommunities', methods=['GET'], cors=True)
def get_all_communities():
    return dynamo_db.getAllCommunities()
...
def update_password():
    request = app.current_request
    return dynamo_db.update_password(request.json_body)
