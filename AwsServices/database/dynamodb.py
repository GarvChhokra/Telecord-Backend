...
# Access Key: AKIAVRUVTJC4ZOSSANZZ
# Secret Access Key: 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
class DynamoDB:
    def __init__(self):
    ...
    def getAllCommunities(self):
        return self.community_table.get_all_communities()
    ...
    def get_all_user(self):
        return self.user_table.get_all_user()
