...
class CommunityTable:
    ...
    def get_all_communities(self):
        ...
        :return: A list of community details.
        """
        response = self.table.scan()
        communities = response.get("Items", [])
    ...
    def delete_community(self, data):
        ...
        try:
            ...
            response = self.table.delete_item(Key={"CommunityId": int(data["CommunityId"])})


            return Response(
                body={"message": "Profile updated successfully!", "response": response},
                status_code=200,
            )
